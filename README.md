...
Once these steps are done, you can install the package for the API you need. For instance, to use the Cloud Vision API you need to install the following package:
